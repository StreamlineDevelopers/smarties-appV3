...
const DomaindivItem = ({ name, dataName, id, name1, dataName1, id1, index, isAddDomainOpen = false, onClick = () => { }, onClose, domain, isValid = false, handleDomainChange = () => { }, handleRemoveDomain = () => { }, isEditDomainOpen = false, onBlur = () => { } }) => {
    ...
    <div style={{ display: isAddDomainOpen ? "block" : "none" }} className="domain-div">
      <div className='form-row'>
        <div className="form-control" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
          <input value={domain.value || domain} onChange={(e) => {
      ...
      <div style={{ display: isEditDomainOpen ? "flex" : "none" }} className="form-btn-container">
        <a className="btn-style1 outline" onClick={onClose}>
          <div>Cancel</div>
        </a>
        <a className="btn-style1 button" onClick={handleSave}>
          <div>Save</div>
        </a>
      </div>
    </div>);
