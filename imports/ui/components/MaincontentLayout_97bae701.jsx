...
import Btnstyle1Item_1c4932a3 from './Btnstyle1Item_1c4932a3';
...
import Btnstyle1Item_371d8027 from './Btnstyle1Item_371d8027';
              ...
              <div className={'step-card'}>
                ...
                <div className={'preview-div'}>
                  ...
                  <div className={'content-paragraph'}>
                    {
                      "Artificial intelligence is no longer just a buzzword in the marketing world—it's a transformative force that's reshaping how businesses connect with their audiences. In this article, we'll explore ten significant ways AI is revolutionizing digital marketing strategies in 2023."
                    }
                  </div>
                  ...
                  <div className={'content-paragraph'}>
                    {
                      'Gone are the days of generic content. AI now enables marketers to create highly personalized content at scale, tailoring messages to individual user preferences, behaviors, and demographics.'
                    }
                  </div>
                  <div className={'content-paragraph'}>
                    {
                        ...
                        <div className={'headline-list'}>
                          ...
                          <div className={'headline-radiocard'}>
                            ...
                            <div className={'headline-body-text'}>
                              {
                                'Discuss the balance between automation and authenticity in the age of AI-generated content.'
                              }
                            </div>
...
export default MaincontentLayout_97bae701;
