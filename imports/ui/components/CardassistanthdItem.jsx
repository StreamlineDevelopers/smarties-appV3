  ...
  return (
    ...
    >
      <CardassistanthdleftItem
        divText={divText || 'Model'}
        description={description || 'Configure the behavior of the assistant.'}
      />
      <div className="assistant-arrow">
        <img
          ...
          alt=""
          src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681cc3b22a53d368aff451c3_smarties-icon-arrow-down.svg"
          loading="lazy"
