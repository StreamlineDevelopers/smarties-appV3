...
import InboxitemItem373 from './InboxitemItem373';
import MenuitemItem44 from './MenuitemItem44';
import FormrowItem385 from './FormrowItem385';
import FormrowItem386 from './FormrowItem386';
import FormrowItem389 from './FormrowItem389';
import PopupformhddivItem391 from './PopupformhddivItem391';
import Noticedivstyle2Item from './Noticedivstyle2Item';
import PropertylistItem from './PropertylistItem';
import PropertydivItem from './PropertydivItem';
import FormrowItem392 from './FormrowItem392';
import HeaderlistItem from './HeaderlistItem';
import MessagedivItem from './MessagedivItem';

const MaincontentLayout400 = ({}) => {
  return (
    <div
        ...
        <div className={'mainwidth-control horizontal'}>
          <div className={'sidebar-temp'}>
            ...
            <div className={'inbox-list'}>
              <InboxitemItem373 divText={'send_text_tool'} />
              <InboxitemItem373 divText={'function_tool'} />
            </div>
          </div>
...
export default MaincontentLayout400;
