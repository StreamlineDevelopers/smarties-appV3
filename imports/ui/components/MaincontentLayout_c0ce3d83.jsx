...
import DashboardactivityfeedItem_3d775350 from './DashboardactivityfeedItem_3d775350';
                  ...
                  <div className={'db-stat-card-left'}>
                    ...
                    <div className={'db-stat-value-contain gap-10'}>
                      ...
                      <DbstattagItem
                        ...
                        divText={'12%'}
                      />
                      <div className={'db-journey-subtext'}>from last week</div>
                    </div>
                  </div>
                </div>
                <div className={'db-stat-card size-stretch'}>
                  <div className={'db-stat-card-left'}>
                    ...
                    <div className={'db-stat-value-contain gap-10'}>
                      ...
                      <DbstattagItem
                        ...
                        divText={'347'}
                      />
                      <div className={'db-journey-subtext'}>engagements</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className={'dashboard-quickactions-div'}>
                ...
                >
                  ...
                  <div className={'db-quickaction-textcontent'}>
                    <div className={'db-quickaction-hd-text'}>Write Blog</div>
                    <div className={'db-quickaction-text'}>
                      Create long-form articles to establish authority and drive
                      organic traffic.
                    </div>
                ...
                >
                  ...
                  <div className={'db-quickaction-textcontent'}>
                    <div className={'db-quickaction-hd-text'}>Social Post</div>
                    <div className={'db-quickaction-text'}>
                      Create long-form articles to establish authority and drive
                      organic traffic.
                    </div>
                ...
                >
                  ...
                  <div className={'db-quickaction-textcontent'}>
                    ...
                    <div className={'db-quickaction-text'}>
                      Record audio content to connect with your audience in a
                      more personal way.
                    </div>
                    ...
                    <div className={'contactdetails-tabscontent w-tab-content'}>
                      ...
                      >
                        <div className={'activity-tabpane-div'}>
                          ...
                          <div className={'dashboard-activityfeed'}>
                            ...
                            <div className={'activityfeed-textcontent'}>
                              <div className={'db-card-title'}>
                                <strong>Podcast draft created</strong> from
                                trending topic: <strong>#RetailAI</strong>
                              </div>
                          ...
                          <DashboardactivityfeedItem_3d775350 />
                          <DashboardactivityfeedItem />
                          <DashboardactivityfeedItem_3d775350 />
                        </div>
                      </div>
...
export default MaincontentLayout_c0ce3d83;
