...
const TopbarLayout_c627851a = ({}) => {
  return (
    <div
      id={'w-node-dba63367-a3c0-a270-a6c5-3baa1a9c725c-f14725b4'}
      className={'topbar'}
    >
      <div className={'search-formblock w-form'}>
        <form
          ...
          method={'get'}
          data-wf-page-id={'688b61ee631f6165f14725b4'}
...
export default TopbarLayout_c627851a;
