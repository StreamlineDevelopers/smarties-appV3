...
import TablerowItem293 from './TablerowItem293';
import FileinforowItem290 from './FileinforowItem290';
import Btnstyle1Item291 from './Btnstyle1Item291';

const MaincontentLayout295 = ({ props }) => {
  return (
    <div
          ...
          <div className="filemanagement-main">
            ...
            <div className="table-main">
              <div className="table-header">
                ...
                <TablecelldivItem287 divText="Size" />
                <TablecelldivItem287 divText="Modified" />
          ...
          <div className="mainbody-col">
            ...
            <div className="phonenumber-group">
              <div className="file-info-contain">
                <FileinforowItem290 label="File ID" divText="FL-123456677" />
                <FileinforowItem290
                  label="Type"
                ...
                <FileinforowItem290
                  ...
                  divText="May 6, 2025 at 10:42 AM"
                />
                <FileinforowItem290 label="Location" divText="Root Directory" />
              </div>
            </div>
            <div className="phonenumber-group">
...
export default MaincontentLayout295;
