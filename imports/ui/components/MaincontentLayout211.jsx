...
import MessagingtablinkItem201 from './MessagingtablinkItem201';
...
import MenuitemItem44 from './MenuitemItem44';
import SidebarleadinfotimelineitemItem209 from './SidebarleadinfotimelineitemItem209';
import SenddelightcardItem from './SenddelightcardItem';
import PlanusagedivtextcontentItem203 from './PlanusagedivtextcontentItem203';
import DbquickactiontextcontentItem204 from './DbquickactiontextcontentItem204';
import DbstatcardItem206 from './DbstatcardItem206';
import RelationshipcardItem from './RelationshipcardItem';

const MaincontentLayout211 = ({}) => {
  return (
    <div
          ...
          <div className={'sidebar-temp messaging'}>
            ...
            >
              <div className={'messaging-tabsmenu w-tab-menu'}>
                ...
                <MessagingtablinkItem201 dataWTab={'Tab 2'} divText={'Gold'} />
                <MessagingtablinkItem201
                  dataWTab={'Tab 3'}
                  divText={'Silver'}
                />
                <MessagingtablinkItem201
                ...
                <div className={'form-body'}>
                  ...
                  <div className={'interaction-history-body'}>
                    ...
                    <div className={'sidebar-leadinfo-timeline-div'}>
                      ...
                      <SidebarleadinfotimelineitemItem209
                  ...
                  <div className={'delivery-settings-group'}>
                    <div className={'contact-row-container'}>
                      <div className={'enrichmentusage-card gap-5'}>
                        <PlanusagedivtextcontentItem203
...
export default MaincontentLayout211;
