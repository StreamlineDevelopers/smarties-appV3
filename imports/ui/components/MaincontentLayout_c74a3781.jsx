...
import FormhddivrightItem_9a765689 from './FormhddivrightItem_9a765689';
import Noticedivstyle2Item_4778ebad from './Noticedivstyle2Item_4778ebad';
import DomainlistItem from './DomainlistItem';
import DomaindivItem from './DomaindivItem';

const MaincontentLayout_c74a3781 = ({}) => {
  return (
    <div
        ...
        <div className={'mainwidth-control horizontal stretch'}>
          <div className={'sidebar-temp'}>
            ...
            <div className={'inbox-list'}>
              <InboxitemItem_718f2b7b divText={'Configuration 01'} />
...
export default MaincontentLayout_c74a3781;
