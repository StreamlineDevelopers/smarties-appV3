...
import FiltergroupItem361 from './FiltergroupItem361';
import FiltergroupItem344 from './FiltergroupItem344';
import FiltergroupItem347 from './FiltergroupItem347';
import FiltergroupItem from './FiltergroupItem';
import FiltergroupItem353 from './FiltergroupItem353';
import Btnstyle12Item from './Btnstyle12Item';
import WformdoneItem from './WformdoneItem';
import WformfailItem from './WformfailItem';
import MessagingtablinkItem334 from './MessagingtablinkItem334';
import DurationtooltipItem from './DurationtooltipItem';
import FilterdropdownItem from './FilterdropdownItem';
import MessaginginboxavatarItem348 from './MessaginginboxavatarItem348';
...
import MessaginginboxitemrightItem360 from './MessaginginboxitemrightItem360';
import MessaginginboxtextcontentItem356 from './MessaginginboxtextcontentItem356';
...
import RowprofilecontactdetailsItem354 from './RowprofilecontactdetailsItem354';
...
import RowprofilecontactdetailsItem352 from './RowprofilecontactdetailsItem352';
...
import RowenrichmentItem351 from './RowenrichmentItem351';
import RowenrichmentItem355 from './RowenrichmentItem355';

const MaincontentLayout363 = ({ props }) => {
  return (
    <div
          ...
          <div className="sidebar-temp messaging shadow">
                ...
                <div className="filter-popup">
                  <div className="w-form">
                    <form
                      ...
                      data-wf-element-id="22da1d15-a272-dba8-d763-7cbf1103c833"
                    >
            ...
            >
              <div className="messaging-tabsmenu w-tab-menu">
                ...
                <MessagingtablinkItem334 dataWTab="Tab 2" divText="Active" />
                <MessagingtablinkItem334 dataWTab="Tab 3" divText="Pending" />
                <a
                  data-w-tab="Tab 4"
                  className="messaging-tablink close w-inline-block w-tab-link"
                >
                  ...
                  <div className="messaging-tabpane-div">
                    ...
                    <div className="inbox-list gap-5">
                      ...
                      >
                        <div className="messaging-inbox-item-left">
                          ...
                          <div className="messaging-inbox-textcontent">
                            <div className="messaging-inbox-textcontent-top">
                              <MessaginginboxnamerowItem329 divText="John Smith" />
                        ...
                        <MessaginginboxitemrightItem360 dataWId="fc19d0d7-f5e8-4f20-e129-a4d9753767c8" />
                      </a>
                      <a
                        href="#"
                      ...
                      >
                        <div className="messaging-inbox-item-left">
                          ...
                          <MessaginginboxtextcontentItem356
                            divText="Emma Wilson"
                            divText1="I’m having an issue with logging in after the latest update..."
                            divText2="Feature request follow-up"
                            dataWId="5412962f-dc78-9f6c-9b1b-5129db7c78df"
                            divText3="25m ago"
                          />
                        </div>
                        <MessaginginboxitemrightItem360 dataWId="2ee757d2-bd3e-4a12-ca0b-91902938181b" />
                      </a>
                      <a
                        href="#"
                        className="messaging-inbox-item w-inline-block"
                      >
                        <div className="messaging-inbox-item-left">
                          <div className="messaging-inbox-avatar-col">
                            <div className="messaging-inbox-avatar">
                              ...
                              <div className="chat-status-div">
                                <div
                                  data-w-id="d640b168-e14b-d21f-cb34-702cefb62695"
                          ...
                          <div className="messaging-inbox-textcontent">
                            <div className="messaging-inbox-textcontent-top">
                              <MessaginginboxnamerowItem329 divText="James Rodriguez" />
                              <div className="messaging-inbox-preview-div">
                                <div className="messaging-inbox-icon-status">
                                  <img
                                    loading="lazy"
                                ...
                                <div className="messaging-inbox-icon-status">
                                  <img
                                    loading="lazy"
                                    src="images/smarties-inbox-icon-attachment_1.svg"
                                    alt=""
                                  />
                                </div>
                                <div className="messaging-inbox-preview">
                        ...
                        <MessaginginboxitemrightItem dataWId="d640b168-e14b-d21f-cb34-702cefb626af" />
                      </a>
                      <a
                        href="#"
                        className="messaging-inbox-item w-inline-block"
                        ...
                        <div className="messaging-inbox-item-left">
                          <div className="messaging-inbox-avatar-col">
                            <div className="messaging-inbox-avatar">
                              ...
                              <div className="chat-status-div">
                                <div
                                  data-w-id="560112a4-5782-ac37-5ecd-0293c66568de"
                          ...
                          <MessaginginboxtextcontentItem356
                            divText="Sofie Chen"
                            divText1="When can I expect a response regarding my last request?..."
                            divText2="Workshop scheduling"
                            dataWId="4e0b7313-3549-b25d-94af-358acacf7cb9"
                            divText3="1h ago"
                          />
                        </div>
                        <MessaginginboxitemrightItem dataWId="560112a4-5782-ac37-5ecd-0293c66568fc" />
                      </a>
                    </div>
                  </div>
                </div>
                        ...
                        <div className="messaging-mainbtns-div">
                          ...
                          <div className="assistant-menu">
                            ...
                            <div className="menu-dropdown">
                              <Menuitem2Item
                                src="https://cdn.prod.website-files.com/688b6671a965c0c9a8b117a1/688b7fe296eb413c7eda8de5_mark-as-read.svg"
                                divText="Mark as Read"
                              />
                              <Menuitem2Item
                                src="https://cdn.prod.website-files.com/688b6671a965c0c9a8b117a1/688b7fe28433d6d3cf92e285_Mute%20Notifications.svg"
                                divText="Mute Notifications"
                              />
                              <Menuitem2Item
                                src="https://cdn.prod.website-files.com/688b6671a965c0c9a8b117a1/688b7fe2854556503e176ce6_Close%20Conversation.svg"
                                divText="Close Conversation"
                              />
                              <Menuitem2Item
                                src="https://cdn.prod.website-files.com/688b6671a965c0c9a8b117a1/688b7fe2787c0f456cb193a6_Block%20Customer.svg"
                                divText="Block Customer"
                              />
                              <Menuitem2Item
                                src="https://cdn.prod.website-files.com/688b6671a965c0c9a8b117a1/688b804529965eda4739367a_Report%20Conversation.svg"
                                divText="Report Conversation"
                              />
                              <Menuitem2Item
                                src="https://cdn.prod.website-files.com/688b6671a965c0c9a8b117a1/688b7fe201846cc31b113601_export%20transcription.svg"
                                divText="Export Transcription"
                              />
                              <Menuitem2Item
                                src="https://cdn.prod.website-files.com/688b6671a965c0c9a8b117a1/688b7fe234f6c4b4f038ee94_off%20ai.svg"
                              ...
                              <div className="menu-item-2 delete">
                                <div className="menu-item-icon">
                                  <img
                                    loading="lazy"
                                    src="https://cdn.prod.website-files.com/688b6671a965c0c9a8b117a1/688b7fe26d6c5f9871c67cb6_delete.svg"
                                    alt=""
                                  />
                                </div>
                                <div>Delete</div>
                    ...
                    <div className="messaging-main-conversation-div">
                        ...
                        <div className="convo-bubble-inbound audio">
                          <div className="message-player">
                            ...
                            <div className="btn-transcript-div">
                              <div
                                data-w-id="ae3dc1d9-8baa-fe66-a02c-6c234151c942"
                              ...
                              >
                                ...
                                <div className="icon-arrow-orange">
                                  <img
                                    loading="lazy"
                                    src="images/smarties-icon-arrow-orange.svg"
                                    alt=""
                                  />
                                </div>
                              </div>
                              <div
                                data-w-id="ae3dc1d9-8baa-fe66-a02c-6c234151c947"
                          ...
                          <div className="message-attachment-div">
                            <div className="attachments-image first">
                              ...
                              <div className="attachment-lmage-info-icon">
                                <div className="icon_i">
                                  <img
                                    loading="lazy"
                                    src="https://uploads-ssl.webflow.com/63086fbe0343fac5859fb3d5/630f1e623053b90c78b63dcf_a_media_43.svg"
                                    alt=""
                                  />
                                </div>
                                <SmsattachmentpopupItem header="SampleFilename.jpg" />
                              </div>
                            </div>
                            <div className="attachments-video">
                              ...
                              <div className="video-play">
                                <img
                                  loading="lazy"
                                  src="https://uploads-ssl.webflow.com/625d3aea722faf41988e5366/625d3aea722fafb8638e54fa_Asset%202260.svg"
                                  alt=""
                                />
                              </div>
                      ...
                      <div className="convo-outbound">
                        ...
                        <div className="convo-bot-avatar">
                          <img
                            loading="lazy"
                            src="images/smarties_account_avatar_1smarties_account_avatar.png"
                            alt=""
                          />
                        </div>
                      </div>
                      ...
                      <div className="reply-row-aisuggestion-row">
                        <div className="message-chat-div">
                          <div className="message-chat-left">
                            <div>
                              <div
                                data-w-id="c48cdb12-9fb9-f2df-92c5-a704498a5c23"
                              ...
                              <div
                                data-w-id="c48cdb12-9fb9-f2df-92c5-a704498a5c28"
                        ...
                        <div className="reply-btn-container">
                          ...
                          <div className="popup-scriptinjection">
                            <div className="message-popup-hd">
                              ...
                              <a
                                data-w-id="8badf8db-09fe-5c18-4ceb-bfbf6893b9eb"
                                href="#"
                                target="_blank"
                            ...
                            <div className="message-popup-body">
                              <div className="message-popup-searchfilter-row">
                                ...
                                <div className="messagepopup-filter">
                                  <MessagepopupfilterselectItem optionText="Script Author" />
                                  <MessagepopupfilterselectItem optionText="Latest" />
                                </div>
                              </div>
                              <div className="scriptinjector-list">
                                <ScriptinjectorcarditemItem
                                  ...
                                  description="Guide the customer through subscription issues and billing problems"
                                />
                                <ScriptinjectorcarditemItem
                                  dataWId="3acdc403-fb7c-4b60-f871-569ee9d1b415"
                                  title="Product Return Process"
                                  description="Walk the customer through the return and refund process"
                                />
                                <ScriptinjectorcarditemItem
                                  dataWId="2d6538e1-3760-0c39-902a-0a4f1d3b954a"
                                  title="Account Recovery"
                                  description="Help the customer recover or reset their account credentials"
                                />
                                <ScriptinjectorcarditemItem
                                  dataWId="e5357c3e-f9e6-2c36-160d-a7b5adc78490"
                                  title="Technical Support"
                                  description="Provide technical troubleshooting for common product issues"
                                />
                              </div>
                            </div>
                          </div>
            ...
            <div className="side-column-content">
              ...
              >
                <div className="tabs-menu-side-column w-tab-menu">
                  <a
                    data-w-tab="Tab 1"
                    className="tabs-menu-link-side-column w-inline-block w-tab-link w--current"
                  >
                              ...
                              <div className="profile-contact-details">
                                ...
                                <div className="flex-contact-details">
                                  <div className="col-contact-details">
                                    <RowprofilecontactdetailsItem354
                                      dataWId="420b0f02-28d9-8e15-64f3-0d8b5aa4b12b"
                                      src="images/smarties-contact-ip.svg"
                                      divText="IP Address"
                                      divText1="192.168.1.254"
                                      dataWId1="420b0f02-28d9-8e15-64f3-0d8b5aa4b133"
                                    />
                                    <RowprofilecontactdetailsItem
                                      dataWId="420b0f02-28d9-8e15-64f3-0d8b5aa4b139"
                                      src="images/smarties-contact-location.svg"
                                      divText="Location"
                                      divText1="San Francisco, CA"
                                    />
                                    <RowprofilecontactdetailsItem354
                                      dataWId="420b0f02-28d9-8e15-64f3-0d8b5aa4b142"
                                      src="images/smarties-contact-weather.svg"
                                      divText="Weather"
                                      divText1="72°F, Sunny"
                                      dataWId1="420b0f02-28d9-8e15-64f3-0d8b5aa4b14a"
                                    />
                                  </div>
                                  <div className="location-preview">
                                    ...
                                    <div
                                      data-w-id="420b0f02-28d9-8e15-64f3-0d8b5aa4b151"
                                      className="button-location-expand"
                                    >
                                      <div className="icon-expand">
                                        <img
                                          loading="lazy"
                                          src="images/smarties-icon-expand.svg"
                                          alt=""
                                        />
                                      </div>
                                      <div>Expand</div>
                                ...
                                <div className="location-expanded">
                                  <img
                                    loading="lazy"
                                    src="images/smarites-location-expanded.png"
                                    alt=""
                                  />
                                  <div className="details-sunny">
                                    <img
                                  ...
                                  <div
                                    data-w-id="420b0f02-28d9-8e15-64f3-0d8b5aa4b15a"
                                    className="button-location-minimize"
                                  >
                                    <div className="icon-expand">
                                      <img
                                        loading="lazy"
                                        src="images/smarties-icon-close-location.svg"
                                        alt=""
                                      />
                                    </div>
                                    <div>Minimize</div>
                            ...
                            <div className="card-side-column-content">
                              <div className="sidebar-acctdetails-body">
                                ...
                                <div className="sidebar-acctdetails-row">
                                  ...
                                  <div className="sidebar-acctdetails-data bg-green">
                                    Tiny
                                  </div>
                                </div>
                                <div className="sidebar-acctdetails-row">
                                  ...
                                  <div className="sidebar-acctdetails-data bg-orange">
                                    Premium
                                  </div>
                                </div>
                              </div>
                    ...
                    <div className="side-column-journey">
                      <div className="journey-main-content dont-shrinkgrow">
                        <div className="card-live-session">
                          ...
                          <RowprofilecontactdetailsItem352
                              ...
                              <div className="customer-journey">
                                <div className="row-journey">
                                  <div className="icon-journey">
                                    <img
                                      loading="lazy"
                                      src="images/smarties-icon-journey-checkout.svg"
                                      alt=""
                                    />
                                  </div>
                                ...
                                <div className="row-journey">
                                  <div className="icon-journey">
                                    <img
                                      loading="lazy"
                                      src="images/smarties-icon-journey-cart.svg"
                                      alt=""
                                    />
                                  </div>
                                  <div className="card-journey">
                                ...
                                <div className="row-journey">
                                  <div className="icon-journey">
                                    <img
                                      loading="lazy"
                                      src="images/smarties-icon-journey-home.svg"
                                      alt=""
                                    />
                                  </div>
                                  <div className="card-journey">
                      ...
                      <div className="history-search-filter">
                        <div>
                          <div className="history-search-div">
                            ...
                            <div className="a_inbox-filter-div">
                              <div
                                data-w-id="e9437ced-afb3-128d-601f-b209ddd0bb09"
                                className="a_filter-btn"
                              >
                                <img
                                  loading="lazy"
                              ...
                              <div className="filter-popup history">
                                <div className="w-form">
                                  <form
                                    ...
                                    method="get"
                                    data-wf-page-id="688b61ee631f6165f14725cd"
                                    data-wf-element-id="e9437ced-afb3-128d-601f-b209ddd0bb0d"
                                  >
                        ...
                        <div className="history-filter">
                          <div className="form-block-2 w-form">
                            <form
                              ...
                              data-wf-page-id="688b61ee631f6165f14725cd"
                              data-wf-element-id="420b0f02-28d9-8e15-64f3-0d8b5aa4b23a"
                            >
                      ...
                      <div className="journey-main-content">
                        ...
                        <div className="w-form">
                          <form
                            ...
                            method="get"
                            data-wf-page-id="688b61ee631f6165f14725cd"
                            data-wf-element-id="62432dc4-3998-68c5-310a-091a787ae285"
                          >
                            <div className="add-data-div">
                              ...
                              <div className="adddatadiv-btncontain">
                                <div className="div-block-14">
                                  <a
                                    data-w-id="faf67c65-037e-bc5e-951e-f27278871811"
                                    href="#"
                                    className="link-text"
                                  >
                                    Cancel
                          ...
                          <div className="card-side-column">
                            ...
                            >
                              ...
                              <div className="side-column-arrow">
                                <img
                                  loading="lazy"
                                  src="https://cdn.prod.website-files.com/6863b2cd9d992eee2240d5c5/6863b2cd9d992eee2240d603_vuesax%2Foutline%2Farrow-down.svg"
                                  alt=""
                                />
                              </div>
                            </div>
                ...
                <div className="form-block-2 w-form">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <RowenrichmentItem351 divText="Company Size" />
                      <RowenrichmentItem351 divText="Company Revenue" />
                ...
                <div className="enrichment-loading">
                  <div className="loading-lottie">
                    <div
                      ...
                      data-src="https://cdn.prod.website-files.com/688b61f29ddc05275744387e/688b61f29ddc0527574438e6_smarties-loading-animation-3.json"
                      data-loop="1"
                      data-direction="1"
                      data-autoplay="1"
...
export default MaincontentLayout363;
