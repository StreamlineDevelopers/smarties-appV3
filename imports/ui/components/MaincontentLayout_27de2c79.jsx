...
import DashboardactivityfeedItem_9f8babc1 from './DashboardactivityfeedItem_9f8babc1';
import ActivityfeedtextcontentItem_a0577d24 from './ActivityfeedtextcontentItem_a0577d24';
...
const MaincontentLayout_27de2c79 = ({}) => {
  return (
    <div
          ...
          <div className={'mainwidth-control journey'}>
            ...
            <div className={'dashboard-col-group'}>
              ...
              <div className={'dashboard-group stretch'}>
                ...
                <div className={'db-recentassistants-card'}>
                  <DashboardactivityfeedItem_9f8babc1 />
                  ...
                  <div className={'dashboard-activityfeed'}>
                    ...
                    <ActivityfeedtextcontentItem_a0577d24
...
export default MaincontentLayout_27de2c79;
