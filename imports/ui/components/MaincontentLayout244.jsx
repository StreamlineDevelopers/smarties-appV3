...
import FilterdropdownItem241 from './FilterdropdownItem241';
import MessaginginboxavatarcolItem236 from './MessaginginboxavatarcolItem236';
...
import PlanusagedivtextcontentItem237 from './PlanusagedivtextcontentItem237';
...
import EnrichmentusagecardItem240 from './EnrichmentusagecardItem240';

const MaincontentLayout244 = ({}) => {
  return (
    <div
          ...
          <div className={'sidebar-temp'}>
            ...
            <div className={'messaging-tabpane-div'}>
              <div className={'filter-row gap-10'}>
                <FilterdropdownItem241 divText={'Role'} />
                <FilterdropdownItem241 divText={'Status'} />
              </div>
              <div className={'inbox-list gap-5'}>
                ...
                >
                  <MessaginginboxavatarcolItem236
                ...
                <div className={'form-body'}>
                  ...
                  <div className={'dataenrichment-control-group'}>
                    ...
                    <div className={'plan-usage-div'}>
                      <PlanusagedivtextcontentItem237
                        label={'Current Usage'}
                        divText={'7/50 today'}
                      />
...
export default MaincontentLayout244;
