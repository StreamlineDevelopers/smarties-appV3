...
import InboxitemItem401 from './InboxitemItem401';
import MenuitemItem44 from './MenuitemItem44';
import ConfiginfoItem from './ConfiginfoItem';
import FormhddivrightItem409 from './FormhddivrightItem409';
import Noticedivstyle2Item402 from './Noticedivstyle2Item402';
import DomainlistItem from './DomainlistItem';
import DomaindivItem from './DomaindivItem';

const MaincontentLayout413 = ({}) => {
  return (
    <div
        ...
        <div className={'mainwidth-control horizontal stretch'}>
          <div className={'sidebar-temp'}>
            ...
            <div className={'inbox-list'}>
              <InboxitemItem401 divText={'Configuration 01'} />
              <InboxitemItem401 divText={'Configuration 02'} />
            </div>
          </div>
...
export default MaincontentLayout413;
