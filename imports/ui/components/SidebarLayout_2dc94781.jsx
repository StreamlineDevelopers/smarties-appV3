...
import SidemenuitemItem_824eb99a from './SidemenuitemItem_824eb99a';
import SidemenuitemItem_a68a49aa from './SidemenuitemItem_a68a49aa';

const SidebarLayout_2dc94781 = ({}) => {
  return (
    <div
      ...
      <div className={'sidemenu-list'}>
        <div className={'sidemenu-top'}>
          ...
          >
            ...
            />
            <div>Journey Dashboard</div>
          </a>
          <SidemenuitemItem_824eb99a
...
export default SidebarLayout_2dc94781;
