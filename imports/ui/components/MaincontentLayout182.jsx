...
import DbstattagItem169 from './DbstattagItem169';
import Divblock18Item from './Divblock18Item';
import ContacttablecelldivItem from './ContacttablecelldivItem';
import ContacttablecelldivItem165 from './ContacttablecelldivItem165';
import ContacttablerowItem180 from './ContacttablerowItem180';
...
import ContacttablecelldivItem174 from './ContacttablecelldivItem174';
    ...
    >
      <div className={'scroll-content'}>
        <div className={'hd-div'}>
          <div>
            <div className={'page-header-text'}>Turn Shoppers Into Buyers</div>
              ...
              <div className={'db-stat-card-contain'}>
                <div className={'db-stat-card'}>
                  <div className={'db-stat-card-left'}>
                    <div className={'stat-title'}>Conversion Rate Today</div>
                ...
                <div className={'db-stat-card'}>
                  <div className={'db-stat-card-left'}>
                    <div className={'stat-title'}>Most Common Objection</div>
                    <div className={'db-stat-value-contain'}>
                      <Divblock18Item
                ...
                <div className={'form-body'}>
                  <div className={'contact-table-div leadstable'}>
                    <div className={'contacts-main-top'}>
                      <div className={'messaging-sidebar-h1'}>Leads Table</div>
                    ...
                    <div className={'contacts-tableheader mt-10'}>
                      ...
                      <div className={'contact-table-cell-div _w-10'}>
                        <div className={'contact-table-header-text'}>score</div>
                      </div>
                      <ContacttablecelldivItem165 header={'last activity'} />
                      <ContacttablecelldivItem header={'suggested action'} />
                      <ContacttablecelldivItem165 header={'actions'} />
                    </div>
                    <div className={'contacts-table-content'}>
                      ...
                      <div className={'contact--table-row'}>
                        ...
                        <div className={'contact-table-cell-div _w-10'}>
                          <div className={'contacts-table-tags-div'}>
                            <div className={'leadstable-score bg-blue'}>88</div>
                          </div>
                        </div>
                        <ContacttablecelldivItem176
                        ...
                        />
                        <ContacttablecelldivItem174 divText={'Contact'} />
                      </div>
                      <div className={'table-priority-divider'}>
                        <div className={'table-priority-divider-content'}>
                          <div
                      ...
                      <div className={'contact--table-row'}>
                        ...
                        />
                        <ContacttablecelldivItem174 divText={'Send Offer'} />
                      </div>
                      <ContacttablerowItem180
                  ...
                  <div className={'delivery-settings-group'}>
                    ...
                    <div className={'messaging-sidebar-cards gap-5 bg-yellow'}>
                      ...
                      <div className={'sidebar-journey-card-duration'}>
                        Detected when user toggled between your site and
                        competitor sites.
                      </div>
                    </div>
                  </div>
...
export default MaincontentLayout182;
