...
import FormhddivItem_b2274734 from './FormhddivItem_b2274734';
import FormrowItem_f7a2ce62 from './FormrowItem_f7a2ce62';
import FormrowItem_5d1277b2 from './FormrowItem_5d1277b2';
import NoticedivItem from './NoticedivItem';
import WradioItem from './WradioItem';
import Btnstyle1Item_4107f5be from './Btnstyle1Item_4107f5be';

const MaincontentLayout_3c217521 = ({}) => {
  return (
    <div
                ...
                <div className={'form-body'}>
                  ...
                  <div className={'phonenumber-group'}>
                    ...
                    <NoticedivItem
                      ...
                      divText={
                        "Setup a fallback option for when your assistant can't handle a call."
                      }
                    />
                  </div>
                  <div className={'phonenumber-group'}>
                    ...
                    <div className={'form-btn-container left-align'}>
                      ...
                      <Btnstyle1Item_4107f5be divText={'Schedule a Call'} />
                    </div>
                  </div>
                </div>
              </form>
...
export default MaincontentLayout_3c217521;
