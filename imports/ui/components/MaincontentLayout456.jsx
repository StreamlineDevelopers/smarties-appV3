...
import InboxitemItem429 from "./InboxitemItem429";
import MenuitemItem50 from "./MenuitemItem50";
import FormrowItem441 from "./FormrowItem441";
import FormrowItem442 from "./FormrowItem442";
import FormrowItem445 from "./FormrowItem445";
import PopupformhddivItem447 from "./PopupformhddivItem447";
import Noticedivstyle2Item from "./Noticedivstyle2Item";
import PropertylistItem from "./PropertylistItem";
import PropertydivItem from "./PropertydivItem";
import FormrowItem448 from "./FormrowItem448";
import HeaderlistItem from "./HeaderlistItem";
import MessagedivItem from "./MessagedivItem";

const MaincontentLayout456 = ({ props }) => {
  return (
    <div
        ...
        <div className="mainwidth-control horizontal">
          <div className="sidebar-temp">
            ...
            <div className="inbox-list">
              <InboxitemItem429 divText="send_text_tool" />
              <InboxitemItem429 divText="function_tool" />
            </div>
          </div>
                  ...
                  <div className="phonenumber-group">
                    <div className="phonenumber-top">
                      <div className="phonenumber-topleft">
                        <div className="settings-title">send_text_tool</div>
                  ...
                  <div className="phonenumber-group">
                    <div className="form-row">
                      <div className="form-control">
                        ...
                        <PropertylistItem dataWId="1849b75f-9350-98c1-3481-367f0109f9ac" />
                        <PropertydivItem
...
export default MaincontentLayout456;
