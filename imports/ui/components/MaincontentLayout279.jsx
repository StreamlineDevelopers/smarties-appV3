...
import SearchformblockItem275 from './SearchformblockItem275';
import Btnstyle1Item270 from './Btnstyle1Item270';
import TableheaderItem from './TableheaderItem';
import TablerowItem276 from './TablerowItem276';
import FileinforowItem272 from './FileinforowItem272';
import FileitemItem from './FileitemItem';

const MaincontentLayout279 = ({}) => {
  return (
    <div
          ...
          <div className={'filemanagement-main'}>
            ...
            <div className={'table-main'}>
              ...
              <div className={'table-content'}>
                <TablerowItem276 title={'Knowledge Base 1'} />
                <TablerowItem276 title={'Knowledge Base 2'} />
                <TablerowItem276 title={'Knowledge Base 3'} />
                <TablerowItem276 title={'Knowledge Base 3'} />
              </div>
            </div>
          </div>
...
export default MaincontentLayout279;
