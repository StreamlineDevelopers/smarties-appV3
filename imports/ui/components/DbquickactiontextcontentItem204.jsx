...
const DbquickactiontextcontentItem204 = ({ title, divText }) => {
  return (
    <div className={'db-quickaction-textcontent'}>
      <div className={'insights-title'}>{title || 'Grateful & Cheerful'}</div>
...
export default DbquickactiontextcontentItem204;
