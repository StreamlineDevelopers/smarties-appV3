...
import TablecelldivItem_aa9e714c from './TablecelldivItem_aa9e714c';
import TablerowItem from './TablerowItem';

const MaincontentLayout_15d9dfb8 = ({}) => {
  return (
    <div
                ...
                <div className={'plan-card-top-left'}>
                  ...
                  <div className={'plan-card-textcontent'}>
                    ...
                    <div className={'plan-price-text'}>
                      <span className={'span-price'}>{'$29.99'}</span>
                      {' per month'}
                    </div>
          ...
          <div className={'paymenthistory-row'}>
            <div className={'table-main'}>
              ...
              <div className={'table-header'}>
                <TablecelldivItem_aa9e714c divText={'Date'} />
                <TablecelldivItem_aa9e714c divText={'Invoice'} />
                <TablecelldivItem_aa9e714c divText={'Amount'} />
                <TablecelldivItem_aa9e714c divText={'Status'} />
                <TablecelldivItem_aa9e714c divText={'Action'} />
              </div>
...
export default MaincontentLayout_15d9dfb8;
