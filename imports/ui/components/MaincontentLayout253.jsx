...
import TablerowItem251 from './TablerowItem251';
import FileinforowItem248 from './FileinforowItem248';
import Btnstyle1Item249 from './Btnstyle1Item249';

const MaincontentLayout253 = ({}) => {
  return (
    <div
          ...
          <div className={'filemanagement-main'}>
            ...
            <div className={'table-main'}>
              <div className={'table-header'}>
                ...
                <TablecelldivItem245 divText={'Size'} />
                <TablecelldivItem245 divText={'Modified'} />
