...
import SidemenuitemItem_cd377471 from './SidemenuitemItem_cd377471';
import SvgiconItem from './SvgiconItem';

const SidebarLayout_0ed0116c = ({}) => {
  return (
    <div
        ...
        <div className={'sidemenu-top'}>
          ...
          >
            <div className={'svg-icon w-embed'}>
              <img
                src="/public/svgs/icon-b602823cec649eccfbef37a946354cf6.svg"
                alt="icon"
              />
            </div>
            <div>Dashboard</div>
...
export default SidebarLayout_0ed0116c;
