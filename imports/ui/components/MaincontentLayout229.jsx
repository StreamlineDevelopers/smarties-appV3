...
import DbstatcardItem225 from './DbstatcardItem225';
...
import DashboardactivityfeedItem222 from './DashboardactivityfeedItem222';
import ActivityfeedtextcontentItem219 from './ActivityfeedtextcontentItem219';
import JourneyquickactionscardItem224 from './JourneyquickactionscardItem224';
import ActivityfeedtextcontentItem218 from './ActivityfeedtextcontentItem218';

const MaincontentLayout229 = ({}) => {
  return (
    <div
                  ...
                  <div className={'db-journey-smartassistant-card'}>
                    ...
                    <div className={'db-journey-smartassistant-card-bot'}>
                      ...
                      <div className={'db-journey-extra-btncontainer'}>
                        <Btnstyle1Item214 divText={'View List'} />
                        <a
                          href={'#'}
              ...
              <div className={'dashboard-group stretch'}>
                ...
                <div className={'db-recentassistants-card'}>
                  ...
                  <div className={'dashboard-activityfeed'}>
                    ...
                    <ActivityfeedtextcontentItem219
          ...
          <div className={'journey-db-rightpanel'}>
            <div className={'dashboard-group'}>
              ...
              <div className={'db-quickactions-container'}>
                <JourneyquickactionscardItem224
...
export default MaincontentLayout229;
