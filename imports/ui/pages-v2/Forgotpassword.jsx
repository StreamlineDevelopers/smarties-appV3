  ...
  <div className="page-wrap-signin">
    <div className="reset-center">
      <div className="forgot-password">
        ...
        <div className="siginin-div">
          <div className="signin-formblock w-form">
            <form id="wf-form-forgot-password-form" name="wf-form-forgot-password-form" data-name="forgot password form" method="get" data-wf-page-id="682dacb7d336cf44f6ca79ac" data-wf-element-id="d2813588-93bc-24f7-b8de-ce2a8d4e5e31">
              <div className="form-row">
                <div className="form-control">
                  <div className="form-label">Email</div><input className="textfield w-input" maxlength="256" name="email-2" data-name="Email 2" placeholder="Enter Email" type="email" id="email-2" />
                </div>
              </div>
              ...
              <div className="form-row-small">
                ...
                <a href="login.html" className="link-style2">Sign In</a>
              </div>
            </form>
      ...
      <div className="reset-link-sent">
        ...
        <div className="siginin-div">
          <div className="signin-formbtn-div">
            <a href="reset-password.html" className="btn-style1 w-inline-block">
