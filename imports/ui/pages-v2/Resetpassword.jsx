...
import FormrowItem89 from '../components/FormrowItem89';
import FormcontrolItem90 from '../components/FormcontrolItem90';
          ...
          <div className="reset-password">
            ...
            <div className="siginin-div">
              <div className="signin-formblock w-form">
                <form id="wf-form-reset-password-form" name="wf-form-reset-password-form" data-name="reset password form" method="get" data-wf-page-id="682dafe4eea1904f74c5f684" data-wf-element-id="139ff807-3ea3-2584-93b9-1c985bf00930">
                  <FormrowItem89 textDiv="New Password" name="new-password" dataName="new password" id="new-password" />
                  <FormrowItem89 textDiv="Confirm New Password" name="confirm-new-password" dataName="confirm new password" id="confirm-new-password" />
