          ...
          >
            ...
            <div className={'chatmenu-avatar'}>
              <img
                loading={'lazy'}
                src={
                  'https://cdn.prod.website-files.com/67ee6a2e2b4993b208083866/67efbf691923fc6908f56d0c_smarties-icon-chat.svg'
                }
                alt={''}
                className={'image-100'}
              />
                  ...
                  >
                    ...
                    <div className={'button-send'}>
                      <img
                        loading={'lazy'}
                        src={
                          'https://cdn.prod.website-files.com/67ee6a2e2b4993b208083866/67eea4c90fdd2d72ba32b16a_smarties-button-send.svg'
                        }
                        alt={''}
                      />
                    </div>
