...
import SvgiconItem408 from './SvgiconItem408';

const SidemenuitemItem420 = ({ href, d, divText }) => {
  return (
    <a
...
export default SidemenuitemItem420;
