...
import TablecelldivItem62 from './TablecelldivItem62';
import TablerowItem from './TablerowItem';

const MaincontentLayout67 = ({ props }) => {
  return (
    <div
              ...
              <div className="plan-card-body">
                ...
                <div className="plandetail-list">
                  ...
                  <PlandetailitemItem
                    ...
                    description="Track interest signals, personalize every interaction, and grow lasting relationships, with zero spammy vibes."
                  />
                  <PlandetailitemItem
                    title="Live AI customer interaction"
                    description="Use SMARTIES to spot when casual interest turns into buying intent"
                  />
                  <PlandetailitemItem
                    title="Smart onboarding + support"
                    description="Answers calls, chats, and texts with friendly, pre-approved replies, your way, anytime."
                  />
                  <PlandetailitemItem
                    title="Email/text follow-ups"
                    description="SMARTIES act like your front desk, phone assistant, and inbox helper, all at once"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="paymenthistory-row">
            <div className="table-main">
              ...
              <div className="table-header">
                <TablecelldivItem62 divText="Date" />
                <TablecelldivItem62 divText="Invoice" />
                <TablecelldivItem62 divText="Amount" />
                <TablecelldivItem62 divText="Status" />
                <TablecelldivItem62 divText="Action" />
              </div>
...
export default MaincontentLayout67;
