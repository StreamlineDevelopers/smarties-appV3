...
import DbstatcardItem304 from './DbstatcardItem304';
import DashboardassistantItem from './DashboardassistantItem';
import DashboardactivityfeedItem303 from './DashboardactivityfeedItem303';

const MaincontentLayout307 = ({ props }) => {
  return (
    <div
            ...
            <div className="dashboard-quickactions-div">
              ...
              >
                <div className="card-icon">
                  <img
                    src="https://cdn.prod.website-files.com/67ece27c367a4f53eeef80d8/681bcd735c29814edecfeac5_Upload.svg"
                    loading="lazy"
                    width="25"
                    height="25"
                    alt=""
                ...
                <div className="db-quickaction-textcontent">
                  ...
                  <div className="db-actionlink">
                    ...
                    <img
                      src="https://cdn.prod.website-files.com/67ece27c367a4f53eeef80d8/681bcd73cdae71b143933bc8_Arrow-right.svg"
                      loading="lazy"
                      width="20"
                      height="20"
                      alt=""
              ...
              >
                ...
                <div className="db-quickaction-textcontent">
                  ...
                  <div className="db-actionlink">
                    ...
                    <img
                      src="https://cdn.prod.website-files.com/67ece27c367a4f53eeef80d8/681bcd73b86c74e8844487fe_Arrow-right.svg"
                      loading="lazy"
                      width="20"
                      height="20"
                      alt=""
...
export default MaincontentLayout307;
