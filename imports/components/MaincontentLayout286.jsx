...
import FilterdropdownItem283 from './FilterdropdownItem283';
import MessaginginboxavatarcolItem278 from './MessaginginboxavatarcolItem278';
...
import Btnstyle1Item75 from './Btnstyle1Item75';
import RecentactivitycardItem from './RecentactivitycardItem';
import EnrichmentusagecardItem282 from './EnrichmentusagecardItem282';

const MaincontentLayout286 = ({ props }) => {
  return (
    <div
    ...
    >
      <div className="scroll-content">
        <div className="hd-div">
          <div>
            <div className="page-header-text">Data Enrichment Control</div>
          </div>
        </div>
          ...
          <div className="sidebar-temp">
            ...
            <div className="messaging-tabpane-div">
              <div className="filter-row gap-10">
                <FilterdropdownItem283 divText="Role" />
                <FilterdropdownItem283 divText="Status" />
              </div>
              <div className="inbox-list gap-5">
                ...
                >
                  <MessaginginboxavatarcolItem278 src="../images/smarties-avatar-03_1smarties-avatar-03.png" />
                ...
                >
                  <MessaginginboxavatarcolItem278 src="../images/smarties-avatar-01_1smarties-avatar-01.png" />
                  <DataenrichmentinboxtextcontentItem
              ...
              >
                <div className="form-body">
                      ...
                      <div className="messaging-main-topleft">
                        ...
                        <div className="messaging-inbox-toptextcontent">
                          <div className="dataenrichment-control-name-div">
                            ...
                            <div className="dataenrich-agent-tab">Agent</div>
                          </div>
                  ...
                  <div className="dataenrichment-control-group">
                    <PopupformhddivItem divText="Data Enrichment Permissions" />
                    ...
                    <div className="teamplan-notice">
                      ...
                      <div className="teamplan-notice-textcontent">
                        <div className="teamplan-notice-text">Team Plan:</div>
            ...
            <div className="messaging-sidebar-cards">
              <div className="sidebar-contact-body">
                ...
                <div className="contact-row-container">
                  <RecentactivitycardItem divText="IP Address visibility enabled" />
                  <RecentactivitycardItem divText="Enrichment limit changed to 25/day" />
                  <RecentactivitycardItem divText="Location data editing disabled" />
                </div>
              </div>
            </div>
            <div className="messaging-sidebar-cards">
              <div className="sidebar-contact-body">
                <div className="messaging-sidebar-h2">Enrichment Usage</div>
                <div className="contact-row-container">
                  <EnrichmentusagecardItem282 label="Today" divText="8 / 25" />
                  <EnrichmentusagecardItem282
                    label="Yesterday"
                    divText="22 / 25"
                  />
                  <EnrichmentusagecardItem282
...
export default MaincontentLayout286;
