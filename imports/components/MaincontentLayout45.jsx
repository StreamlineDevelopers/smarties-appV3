...
import Formrow2Item29 from './Formrow2Item29';
...
import Formrow2Item33 from './Formrow2Item33';
...
import CardformsubrowItem35 from './CardformsubrowItem35';
import Formrow2Item24 from './Formrow2Item24';
import FormcolItem15 from './FormcolItem15';
import SelectfieldItem from './SelectfieldItem';
import Formrow2Item19 from './Formrow2Item19';
import AddformsubItem from './AddformsubItem';
import CardformrowItem27 from './CardformrowItem27';
import CardformrowItem36 from './CardformrowItem36';
import CardformrowItem38 from './CardformrowItem38';
import RowsliderItem34 from './RowsliderItem34';
import CardformrowItem39 from './CardformrowItem39';
import CardformrowleftItem21 from './CardformrowleftItem21';
import ReusableItem17 from './ReusableItem17';
import Formrow2Item32 from './Formrow2Item32';
import ReusableItem9 from './ReusableItem9';
import Formrow2Item43 from './Formrow2Item43';
import Formrow2Item28 from './Formrow2Item28';

const MaincontentLayout45 = ({ props }) => {
  return (
    <div
                ...
                <div className="assistant-buttons-div">
                  <div className="button-edit">
                    <img
                      ...
                      height="15"
                      alt=""
                      src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681cae0a13cc00a2604de3bd_smarties-icon-pencil.svg"
                      loading="lazy"
                  ...
                  <div className="button-chat">
                    ...
                    <img
                      ...
                      height="15"
                      alt=""
                      src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681cae0a33e4300a494891b6_smarties-icon-chat.svg"
                      loading="lazy"
                  ...
                  <div className="button-call-contain">
                    ...
                    >
                      ...
                      <div className="fluentchat-28-regular">
                        <img
                          ...
                          height="15"
                          alt=""
                          src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681cae0afa140afcbeae1062_smarties-icon-call.svg"
                          loading="lazy"
                    ...
                    <div className="button-loading">
                      ...
                      <div
                        ...
                        data-src="../documents/smarties-loading-animation-3.json"
                        data-loop="1"
                        data-direction="1"
                        data-autoplay="1"
                  ...
                  <div>
                    ...
                    >
                      <div className="dropdown-publish-toggle w-dropdown-toggle">
              ...
              <div className="assistant-nav-div">
                <div className="assistant-nav">
                  <AssistantbuttonItem
                    id="model"
                    href="#section-model"
                    src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681ce453b478ee39320e500b_smarties-icon-model.svg"
                    divText="Model"
                  />
                  ...
                  <AssistantbuttonItem
                    ...
                    src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681ce456d66657258663032a_smarties-icon-transcriber.svg"
                    divText="Transcriber"
                  />
                  <div className="nav-line"></div>
                  <AssistantbuttonItem
                    id="voice"
                    href="#section-voice"
                    src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681ce456a9e81cf11c50971a_smarties-icon-voice.svg"
                    divText="Voice"
                  />
                  <NavlineItem />
                  <AssistantbuttonItem
                    id="tools"
                    href="#section-tools"
                    src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681ce4581ad40a3c6f5d8afc_smarties-icon-tools.svg"
                    divText="Tools"
                  />
                  <NavlineItem />
                  <AssistantbuttonItem
                    ...
                    src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681ce4cbb0e61fe94039c0c0_smarties-icon-analysis.svg"
                    divText="Analysis"
                  />
                  <NavlineItem />
                  <AssistantbuttonItem
                ...
                <div className="w-form">
                  ...
                  >
                    <div className="assistant-summary">
                      <CostcontainerItem label="Cost" label1="~$0.08 /min" />
                      <CostcontainerItem label="Latency" label1="~600 ms" />
                    </div>
                    <section id="section-model" className="assistant-section">
                      <AssistanthdItem
                        src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681cb3039ccd3756bdd97431_smarties-icon-model.svg"
                        title="Model"
                        width="24"
                        height="24"
                      />
                                    ...
                                    <div className="first-message-textarea">
                                      <div className="form-textararea-div">
                                        <textarea
                                          ...
                                          placeholder="Hi there! I'm Leo, your go-to for any SmartHome Innovations queries. How can I assist you today?"
                    ...
                    >
                      <AssistanthdItem
                        src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681cb39440e5bb4abe33c31d_smarties-icon-transcriber.svg"
                        title="Transcriber"
                        width="24"
                        height="24"
                      />
                      <div className="assistant-cards-container">
                        <div className="card-assistant">
                          <CardassistanthdItem
                            ...
                            divText="Transcriber"
                            description="Configure the behavior of the transcriber."
                          />
                          <div className="card-assistant-content">
                            <div className="card-content">
                              <div className="col-assistant-model">
                                ...
                                />
                                <CardformrowItem
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfc7e46f2135cf7a6b901_smarties-icon-sound.svg"
                    ...
                    <section id="section-voice" className="assistant-section">
                      <AssistanthdItem
                        src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681cb394934718ed4b4076d9_smarties-icon-voice.svg"
                        title="Voice"
                        width="24"
                        height="24"
                      />
                            ...
                            <div className="card-content">
                              <div className="col-assistant-model">
                                ...
                                <Formrow2Item33
                                  ...
                                  description="These are the punctuations that are considered valid boundaries or delimiters. This helps decides the chunks that are sent to the voice provider for the voice generation as the LLM tokens are streaming in."
                                  id="Punctuation-Boundaries"
                                  name="Punctuation-Boundaries"
                                  dataName="Punctuation Boundaries"
                                  optionText="No Punctuations Boundaries Added"
                                />
                                <div className="card-form-row flex">
                                  <div className="div-block-2">
                                    <CardformrowleftItem
                                      src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681df7e1435a52177a969893_smarties-icon-speed.svg"
                                      divText="Custom Speed Enabled"
                                      description="Enable precise control over voice speed with a custom slider. When disabled, preset speeds will be used."
                                    />
                                    <SwitchdivItem />
                                    <MenuitemItem
                                      src="../images/smarties-icon-version.svg"
                    ...
                    <section id="section-tools" className="assistant-section">
                      <AssistanthdItem
                        src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681cb394c0c53c3cc4a9906b_smarties-icon-tools.svg"
                        title="Tools"
                        width="24"
                        height="24"
                      />
                      <div className="assistant-cards-container">
                        <div className="card-assistant">
                          <CardassistanthdItem
                            ...
                            divText="Tools"
                            description="Tools enable voicebots to perform actions during calls. Add tools from the"
                          />
                          <div className="card-assistant-content">
                            <div className="card-content">
                              <div className="col-assistant-model">
                        ...
                        <div className="card-assistant">
                          ...
                          <div className="card-assistant-content">
                            <div className="card-content">
                              <div className="col-assistant-model">
                                <CardformrowItem
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681df8b83f0ea54f89e5f916_smarties-icon-endcall.svg"
                                ...
                                />
                                <CardformrowItem
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681df8b69fd0be54a895dd18_smarties-icon-keypad.svg"
                                  divText="Dial Keypad"
                                  description="This sets whether the assistant can dial digits on the keypad. Read More"
                                />
                                <div className="form-row-2 flex">
                                  <div className="form-col">
                                    <div className="form--cell-div">
                                        ...
                                        <div className="form-button-group">
                                          <div className="select-phone-number">
                                            <select
                                              ...
                                              className="select-field group w-select"
                                            >
                                          ...
                                          <div className="input-phone-number">
                                            <input
                                              className="form-input group w-input"
                                              maxlength="256"
                                              name="Background-Sound-URL-2"
                                              data-name="Background Sound URL 2"
                      ...
                      <div className="assistant-cards-container">
                        <div className="card-assistant">
                          <CardassistanthdItem
                            ...
                            divText="Summary"
                            description="This is the prompt that's used to summarize the call. The output is stored in call.analysis.summary . You can also find the summary in the Call Logs Page."
                          />
                          <div className="card-assistant-content">
                            <div className="card-content">
                              <div className="col-assistant-model">
                                ...
                                <Formrow2Item33
                                  ...
                                  description="This enforces the rubric of the evaluation upon the Success Evaluation."
                                  id="Analysis-Success-Evaluation-Rubric"
                                  name="Analysis-Success-Evaluation-Rubric"
                                  dataName="Analysis Success Evaluation Rubric"
                                  optionText="No Punctuations Boundaries Added"
                                />
                                <CardformsubrowItem35 />
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="card-assistant">
                          <CardassistanthdItem
                            ...
                            description="Extract structured data from call conversation. You can use Data Schema standalone or in combination with Structured Data Prompt. If both are provided, they are concatenated into appropriate instructions."
                          />
                          <div className="card-assistant-content">
                            <div className="card-content">
                              <div className="col-assistant-model">
                                  ...
                                  <div className="card-form-row flex structure-data">
                                    <div className="card-structured-data">
                                          ...
                                          <div>
                                            <div className="form-row-2 flex">
                                              <FormcolItem15
                                                ...
                                                dataName="Background Sound URL 3"
                                              ...
                                              <div className="form-col">
                                                <div className="form--cell-div">
                                                  ...
                                                  <div className="div-block-13">
                                                    <div className="form-control-2 _40">
                                                      <SelectfieldItem
                                                        id="Analysis-Structured-Data-Type"
                                                        name="Analysis-Structured-Data-Type"
                                                        dataName="Analysis Structured Data Type"
                                                        value="deepgram"
                                                        optionText="deepgram"
                                                        optionText1="String"
                                                      />
                                              ...
                                              <div className="form-col">
                                                <div className="form--cell-div">
                                                  ...
                                                  <div className="form-control-2">
                                                    <WcheckboxItem
                                                      name="Analysis-Structured-Data-Required"
                                                      id="Analysis-Structured-Data-Required"
                                                      dataName="Analysis Structured Data Required"
                                                      htmlFor="Analysis-Structured-Data-Required"
                                      ...
                                      <div className="btn-icon-delete">
                                        <img
                                          loading="lazy"
                                          src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681d2106bd82e64bf878b407_smarties-icon-delete.svg"
                                          alt=""
                                        />
                                      </div>
                                    </div>
                    ...
                    >
                      <AssistanthdItem
                        src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681cb394f4a57d79337a4b5d_smarties-icon-advanced.svg"
                        title="advanced"
                        width="19"
                        height="19"
                      />
                      <div className="assistant-cards-container">
                        <div className="card-assistant">
                          ...
                          <div className="card-assistant-content">
                            <div className="card-content">
                              <div className="col-assistant-model">
                                <CardformrowItem
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa190e2f26fe8c3c6d97_smarties-icon-lock.svg"
                                  divText="HIPAA Compliance"
                                  description="When this is enabled, no logs, recordings, or transcriptions will be stored."
                                />
                                <CardformrowItem27
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa18f667ce45112f5bf4_smarties-icon-card.svg"
                                  divText="PCI Compliance"
                                  description="When enabled, only PCI-compliant providers can be selected."
                                />
                                <CardformrowItem36
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa188f64b8715716271d_smarties-icon-mic.svg"
                                ...
                                />
                                <CardformrowItem27
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa188f64b87157162717_smarties-icon-video.svg"
                            ...
                            <div className="card-content">
                              <div className="col-assistant-model">
                                <CardformrowItem38
                                  ...
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa18e91e348baa064b41_smarties-icon-wait.svg"
                                />
                                <CardformrowItem36
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa1891c8ba4fdcc6eb33_smarties-icon-smart.svg"
                                  divText="Smart Endpointing"
                                  description="Enable for more accurate speech endpoint detection. LiveKit is only available in English."
                                ...
                                <CardformrowItem38
                                  ...
                                  description="Minimum seconds to wait after transcription ending with punctuation."
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa18e91e348baa064b41_smarties-icon-wait.svg"
                                />
                                <CardformrowItem38
                                  divText="On No Punctuation Seconds"
                                  description="Minimum seconds to wait after transcription ending without punctuation."
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa18e91e348baa064b41_smarties-icon-wait.svg"
                                />
                                <CardformrowItem38
                                  divText="On Number Seconds"
                                  description="Minimum seconds to wait after transcription ending with a number."
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa18e91e348baa064b41_smarties-icon-wait.svg"
                                />
                              </div>
                            </div>
                        ...
                        <div className="card-assistant">
                          ...
                          <div className="card-assistant-content">
                            <div className="card-content">
                              <div className="col-assistant-model">
                                <CardformrowItem36
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfaf13b9a15e7280b3bf2_smarties-icon-hourglass.svg"
                                  divText="Voicemail Detection Provider"
                                  description="Vapi uses advanced AI for detection. Google/OpenAI use simpler models. Twilio uses traditional AMD."
                            ...
                            <div className="card-content">
                              <div className="col-assistant-model">
                                <CardformrowItem38
                                  ...
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa2658c410b30f86ec35_smarties-icon-number.svg"
                                />
                                <CardformrowItem38
                                  divText="Voice seconds"
                                  description="This is the seconds customer has to speak before the assistant stops talking."
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa18e91e348baa064b41_smarties-icon-wait.svg"
                                />
                            ...
                            <div className="card-content">
                              <div className="col-assistant-model">
                                <CardformrowItem38
                                  ...
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa183374063fd8ed3e14_smarties-icon-timeout.svg"
                                />
                                <CardformrowItem38
                        ...
                        <div className="card-assistant">
                          <CardassistanthdItem
                            ...
                            description="Configure whether a user can input digits via the keypad, and when to process the input."
                          />
                          <div className="card-assistant-content">
                            <div className="card-content">
                              <div className="col-assistant-model">
                                <CardformrowItem27
                                  ...
                                  description="Accept user input via the keypad"
                                />
                                <CardformrowItem39
                                  src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa183374063fd8ed3e14_smarties-icon-timeout.svg"
                                  divText="Timeout"
                                  description="The number of seconds to wait before processing the user's keypad input. Set to 0 to only wait for a delimiter."
                                />
                                <div className="card-form-row">
                                  <CardformrowleftItem21
                                    src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa2658c410b30f86ec35_smarties-icon-number.svg"
                                    divText="Delimiter"
                                    description="A character that will be used to determine when to process the user's keypad input. If both delimiter and timeout are set, the first to be reached will cause the input to be processed."
                                  />
                                  <div className="div-block-13">
                                    <ReusableItem17 label="#" />
                                    <ReusableItem17 label="*" />
                                  </div>
                                </div>
                              </div>
                        ...
                        <div className="card-assistant">
                          <CardassistanthdItem
                            ...
                            divText="Messaging"
                            description="Message configuration for messages that are sent to and from the assistant."
                          />
                          <div className="card-assistant-content">
                            <div className="card-content">
                              <div className="col-assistant-model">
                                ...
                                <div className="form-row-2">
                                  <div className="card-form-row flex structure-data">
                                    <div className="form-row-2 flex">
                                      <ReusableItem9
                                        label="HTTP Headers"
                                        description="Custom HTTP headers to include in API requests to your server"
                                      />
                                      <div className="add-form-sub small">
                                        <img
                                          ...
                                          height="18"
                                          alt=""
                                          src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681cddae22e0050186cea03e_smarties-icon-add-circle.svg"
                                          loading="lazy"
                                        />
                                ...
                                <Formrow2Item43
                                  ...
                                  description="These are the messages that will be sent to the Client SDKs."
                                  dataWId="379fe386-af88-ed7e-3780-62a6bbc10df3"
                                />
                                <Formrow2Item43
                                  label="Server Messages"
                                  description="These are the messages that will be sent to the Server URL configured."
                                  dataWId="379fe386-af88-ed7e-3780-62a6bbc10e17"
                                />
                                <Formrow2Item28
                                  ...
                                  placeholder="Hi, you've reached Leo at SmartHome Innovations. Sorry I missed your call. Please leave a message, and I'll get back to you as soon as possible."
                                />
                                <Formrow2Item28
                                  ...
                                  placeholder="Thanks for reaching out to SmartHome Innovations. It was great assisting you. Have a wonderful day!"
                                />
                                <div className="form-row-2">
                                  <div className="card-form-row flex structure-data">
                                    <div className="form-row-2">
                                      <ReusableItem9
                                        label="Idle Messages"
                                        description="Messages that the assistant will speak when the user hasn't responded."
                                      />
                                      <div className="form-control-2">
                                        <SelectfieldItem
                                          id="Advanced-Server-Idle-Messages"
                                          name="Advanced-Server-Idle-Messages"
                                          dataName="Advanced Server Idle Messages"
                                          value="deepgram"
                                          optionText="deepgram"
                                    ...
                                    <CardformrowItem39
                                      src="https://cdn.prod.website-files.com/681bd50cca2b1f41b87287dc/681dfa18e64fc824d6014684_smarties-icon-message.svg"
...
export default MaincontentLayout45;
