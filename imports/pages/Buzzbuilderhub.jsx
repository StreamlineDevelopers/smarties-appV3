...
import TopbarLayout100 from '../components/TopbarLayout100';
import MaincontentLayout102 from '../components/MaincontentLayout102';
import SidebarLayout101 from '../components/SidebarLayout101';
...
const Buzzbuilderhub = () => {
  return (
    <>
      <div className="page-wrap">
        <TopbarLayout100 />
        <MaincontentLayout102 />
        <SidebarLayout101 />
          ...
          <div className="popup-card">
            ...
            <div className="w-form">
              <form
                ...
                method="get"
                data-wf-page-id="688b61ee631f6165f14725d2"
            ...
            <div
              data-w-id="a68109ff-67f4-f404-77cb-19f0c68b40e4"
        ...
        <div className="popup-recordvoice">
          <div className="popup-card">
            ...
            <div
              data-w-id="a68109ff-67f4-f404-77cb-19f0c68b4124"
              className="popup-close"
            >
              <img src="../images/smarties-x.svg" loading="lazy" alt="" />
            </div>
