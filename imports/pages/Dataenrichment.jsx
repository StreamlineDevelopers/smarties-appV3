...
import MaincontentLayout286 from '../components/MaincontentLayout286';
import SidebarLayout285 from '../components/SidebarLayout285';
import TopbarLayout284 from '../components/TopbarLayout284';
...
import Btnstyle1Item75 from '../components/Btnstyle1Item75';

const Dataenrichment = () => {
  return (
    <>
      <div className="page-wrap">
        <MaincontentLayout286 />
        <SidebarLayout285 />
        <TopbarLayout284 />
            ...
            <div className="popup-dataenrichment-body">
              <div className="dataenrichment-loadingscreen">
                <div className="dataenrichment-loading">
                  <div
                    data-w-id="7247def3-be94-f575-1c70-aa1428f487e6"
