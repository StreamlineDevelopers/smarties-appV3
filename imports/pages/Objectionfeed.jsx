...
import MaincontentLayout380 from '../components/MaincontentLayout380';
import SidebarLayout379 from '../components/SidebarLayout379';
import TopbarLayout378 from '../components/TopbarLayout378';
      ...
      <div className="page-wrap">
        ...
        <div className="popup-dataenrichment">
          <div className="popup-card _w-70">
            ...
            <div
              data-w-id="650a9fdf-eb40-62bd-8ac2-9a0cde2ee270"
            ...
            <div className="popup-dataenrichment-body">
              <div className="dataenrichment-loadingscreen">
                <div className="dataenrichment-loading">
                  <div
                    data-w-id="650a9fdf-eb40-62bd-8ac2-9a0cde2ee275"
