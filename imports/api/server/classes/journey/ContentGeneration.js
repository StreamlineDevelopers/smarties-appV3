...
class ContentGeneration {
    ...
    async searchImagesPost(searchData) {
        ...
        try {
            ...
            console.error('Error searching images via POST:', error);
    ...
    async analyzeCriterion(criterionData) {
        ...
        try {
            ...
            console.error('Error analyzing criterion:', error);
    ...
    async healthCheck() {
        try {
            ...
            console.error('Error checking content generation health:', error);
    ...
    async imageHealthCheck() {
        try {
            ...
            console.error('Error checking image generation health:', error);
    ...
    async editorHealthCheck() {
        try {
            ...
            console.error('Error checking content editor health:', error);
